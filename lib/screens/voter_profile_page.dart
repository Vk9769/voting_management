...
class _VoterProfilePageState extends State<VoterProfilePage> {
  ...
  Future<void> _loadVoterData() async {
    ...
    // ✅ Dummy Data for "George Fernandes"
    setState(() {
      firstName = prefs.getString('first_name') ?? 'George';
      lastName = prefs.getString('last_name') ?? 'Fernandes';
      fatherName = prefs.getString('father_name') ?? 'Anthony Fernandes';
      voterEmail = prefs.getString('user_email') ?? 'george.fernandes@example.com';
      voterId = prefs.getString('user_id') ?? 'MH/2025/56789';
      phoneNumber = prefs.getString('user_phone') ?? '+91 9876543210';
      documentType = prefs.getString('user_doc_type') ?? 'Aadhaar';
      documentNumber = prefs.getString('user_doc_number') ?? '5678-1234-9087';
    });
  }
  ...
  Future<void> _saveProfile() async {
    ...
    await prefs.setString('user_doc_type', documentType);
    await prefs.setString('user_doc_number', documentNumber);
    await prefs.setString('user_id', voterId);
            ...
            children: [
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      _buildInfoTile(Icons.location_on, "Booth Location", "100-MADHYA VIDHYALA MADHURA ANUSUCHIT DAKSHIN BHAG, BIHAR"),
                      _divider(),
                      _buildInfoTile(Icons.how_to_vote, "Voting Status", "Pending"),
                    ],
                  ),

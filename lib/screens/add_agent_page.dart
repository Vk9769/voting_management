...
class _AddAgentPageState extends State<AddAgentPage> {
  ...
  Map<String, Map<String, Map<String, List<Map<String, dynamic>>>>> locationHierarchy = {};
  ...
  double get _formCompletion {
    ...
    if (_firstNameCtrl.text
        .trim()
        .isNotEmpty) filled++;
    if (_lastNameCtrl.text
        .trim()
        .isNotEmpty) filled++;
    if (_selectedIdType != null) filled++;
    if (_idNumberCtrl.text
        .trim()
        .isNotEmpty) filled++;
    if (_emailCtrl.text
        .trim()
  ...
  Future<void> _submit() async {
    ...
    if (_selectedPart == null || _selectedRole == null ||
        _selectedIdType == null) return;

    setState(() => _loading = true);

    try {
      final uri = Uri.parse(
          'http://13.61.32.111:3000/api/agent'); // ✅ UPDATED URL
  ...
  Widget build(BuildContext context) {
    ...
    final textPrimary = Theme
        .of(context)
        .colorScheme
        .onSurface
        .withOpacity(.9);
    final textSecondary = Theme
        .of(context)
        .colorScheme
        .onSurface
        .withOpacity(.65);
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Add Agent/Admin'),
              ...
              child: Row(
                children: [
                  ...
                  OutlinedButton.icon(
                    ...
                    label: const Text(
                        'Choose', style: TextStyle(color: primary)),
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    (v == null || v
                        .trim()
                        .isEmpty) ? 'First name is required' : null,
                  ),
                  ...
                  TextFormField(
                    ...
                    (v == null || v
                        .trim()
                        .isEmpty) ? 'Last name is required' : null,
                  ),
                  const SizedBox(height: 12),
                  ...
                  TextFormField(
                    ...
                    validator: (v) {
                      if (v == null || v
                          .trim()
                          .isEmpty) return 'Voter ID is required';
                      if (v
                          .trim()
                          .length < 10)
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: const Icon(
                            Icons.confirmation_number, color: primary),
                  ...
                  TextFormField(
                    ...
                    validator: (v) {
                      if (v == null || v
                          .trim()
                          .isEmpty) return 'Password is required';
                      if (v
                          .trim()
                          .length < 6) return 'Minimum 6 characters';
                      return null;
                    },
                  ),
                  const SizedBox(height: 12),
                  ...
                  TextFormField(
                    ...
                    validator: (v) {
                      if (v == null || v
                          .trim()
                          .isEmpty) return 'Phone is required';
          ...
          Card(
            child: Padding(
                ...
                child: Column(
                  ...
                  decoration: const InputDecoration(
                      labelText: "Select State", border: OutlineInputBorder()),
                ),
...
// DISTRICT
            ...
            onChanged: (v) {
              setState(() {
                _selectedDistrict = v;
                _assemblies =
                    locationHierarchy[_selectedState]![v]!.keys.toList();
                _selectedAssembly = null;
                _parts = [];
                _selectedPart = null;
              });
...
// BOOTH
                    if (_selectedAssembly != null)
                      DropdownButtonFormField<String>(
                        value: _selectedPart,
                        items: _parts.map((p) => DropdownMenuItem<String>(
                          value: p["id"].toString(),   // ✅ force string
